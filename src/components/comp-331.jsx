              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    <CheckIcon size={16} strokeWidth={2} className="text-emerald-500" aria-hidden="true" />
                  </div>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex rounded-lg shadow-sm shadow-black/5">
                  <span
                    className="-z-10 inline-flex items-center rounded-s-lg border border-input bg-background px-3 text-sm text-muted-foreground">
                    https://
                  </span>
                  <Input
                    id={`${id}-website`}
        ...
        <div className="absolute inset-0 flex items-center justify-center gap-2">
          ...
          {currentImage && (
            <button
              ...
              <Cross2Icon size={16} strokeWidth={2} aria-hidden="true" />
            </button>
          )}
        </div>
      </div>
