        ...
        <div className="mt-6">
          ...
          >
                            ...
                            <CardHeader className="flex items-center space-x-4 bg-gray-50 p-4 rounded-t-md">
                                ...
                                />
                                <div>
                                <CardTitle className="text-xl font-semibold text-gray-800">{app.title}</CardTitle>
                                <p className="text-sm text-center text-gray-500">{app.orgName}</p>
                                </div>
                            </CardHeader>
                            ...
                            <CardContent className="p-4 flex flex-col flex-grow">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>Experience: {app.yearOfExperience} Years of Experience</span>
                                </li>
                                </ul>
                                ...
                                <p className="text-sm text-gray-500">Applied on: {app.published}</p>
                                </div>
                            </CardContent>
                            </Link>
            ...
            <div className="mt-3 flex items-center justify-end">
                <Link href={"/my-applications"}>
                    <Button>See All Applications</Button>
                </Link>
            </div>
        </div>
    );
