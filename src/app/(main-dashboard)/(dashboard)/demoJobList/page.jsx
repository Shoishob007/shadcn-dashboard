    ...
    <div className="space-y-2">
      {documents.docs.map((document) => {
        ...
        return (
          <Card
            key={document.id}
            className="flex flex-col mx-auto md:flex-row items-center justify-between py-6 md:py-4 px-2 md:px-6 rounded-lg transition-shadow gap-4 md:gap-2 max-w-5xl"
          >
                ...
                <div className="flex items-center space-x-3 md:space-x-3">
                  ...
                  <div className="flex gap-4 md:gap-0 items-center md:flex-col dark:text-gray-200">
                    <div className="flex flex-col md:flex-row gap-2 md:gap-3 items-start md:items-start">
                      ...
                      <div className="md:flex hidden flex-col md:flex-row md:mt-1 gap-1">
