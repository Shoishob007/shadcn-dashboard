...
import PricingCards from "../../demoBillings/pricing/page";
...
const PricingDialogue = ({ onClose }) => {
  return (
    <Dialog open={true} onOpenChange={onClose}>
      ...
      <DialogContent
        className="fixed max-w-5xl w-full max-h-[90vh] overflow-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 sm:p-8"
      >
        <div className="text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">
            Upgrade Your Subscription Plan
          </h2>
          <p className="text-gray-600 dark:text-gray-300 text-sm md:text-sm mb-4 sm:px-10 md:px-20">
