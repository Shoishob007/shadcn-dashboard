            ...
            <Button
              ...
              className={`border ${
                applicant.status === "shortlisted"
                  ? "bg-yellow-100 text-yellow-600 border-yellow-600 dark:border-gray-600 dark:bg-gray-100 dark:text-gray-600 dark:hover:bg-gray-200"
                  : `${
                ...
                <div key={index} className="mb-3 text-sm">
                  ...
                  <div className="flex justify-between sm:flex-col">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-300">
                      {activity.academicActivityType.title} ({activity.duration}{" "}
                      months)
                    </p>
                  </div>
