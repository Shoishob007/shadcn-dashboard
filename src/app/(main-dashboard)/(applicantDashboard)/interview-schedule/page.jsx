    ...
    <div>
      ...
      <section className="grid grid-cols-1 gap-5">
        {shortlisted.map((data) => (
          <Card
            key={data.id}
            className="shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg flex flex-col"
          >
            <CardContent className="p-4  rounded-t-lg flex-grow">
              ...
              <div className="flex items-center justify-between mt-3">
                <div>
                  ...
                  <p className="text-black text-sm font-medium dark:text-gray-200">
                    {data.date}
                  </p>
                </div>
                <div>
            ...
            <CardFooter className="flex justify-end p-4 border-t">
              <Button onClick={() => handleDetails(data.id)} className="">
                Details
              </Button>
            </CardFooter>
          </Card>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1 mt-2">
                              ...
                              <h3 className="capitalize text-black">
                                {interviewDetails.salary} Monthly
                              </h3>
                            </div>
                          </div>
                        </div>
