...
export const jobs = [
  ...
  },
  {
    ...
    jobType: "contractual",
    details:
      "Data analyst interview focusing on data interpretation and visualization skills.",
  },
  {
    id: 8,
    date: "2024-11-28",
    ...
    jobType: "full-time",
    details:
      "Project management interview emphasizing leadership skills and project lifecycle knowledge.",
  },
  {
    id: 9,
    date: "2024-12-01",
    ...
    jobType: "part-time",
    details:
      "Backend developer interview focusing on Node.js and database management.",
  },
  {
    id: 10,
    date: "2024-12-05",
    ...
    jobType: "part-time",
    details:
      "Mobile development interview focusing on Flutter and cross-platform development skills.",
  },
  {
    id: 11,
    date: "2024-12-10",
    ...
    jobType: "full-time",
    details:
      "Cloud architect interview emphasizing design of scalable cloud infrastructures.",
  },
  {
    id: 12,
    date: "2024-12-15",
    ...
    jobType: "part-time",
    details:
      "QA engineer interview focusing on testing methodologies and automation tools.",
  },
];
        ...
        <div className="grid grid-cols-1 gap-4 mt-4">
          {filteredJobs.map((job) => {
            ...
            return (
              <Card
                key={job.id}
                className="p-4 shadow-lg border rounded-lg flex flex-col"
              >
                <CardContent className="">
                  <div>
                    <div className="flex items-center gap-1">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-2">
                          ...
                          <div className="">
                            <button
                              className={`${statusBgColor} py-0.5 px-2 rounded`}
                            >
                              {job.status}
                            </button>
                          </div>
                    ...
                    <div className="mt-2">
                      <div className="flex items-center gap-4">
                        <div>
                          <span className="text-gray-400 mr-2 dark:text-gray-200">
                            Position:
                          </span>
                          <span>{job.position}</span>
                        </div>
                        <div>
                          <span className="text-gray-400 dark:text-gray-200 mr-2">
                            Role:
                          </span>
                          <span>{job.role}</span>
                        </div>
                  ...
                  <div className="flex items-center justify-end">
                    <Button onClick={() => handleDetails(job.id)}>
                      View Details
                    </Button>
                  </div>
                </CardContent>
                  ...
                  {jobDetails && (
                    <>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <h1 className="text-black dark:text-gray-200 font-semibold">
                            {jobDetails.title}
                          </h1>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1 mt-2 dark:text-gray-200">
                              ...
                              <h3 className="capitalize text-black dark:text-gray-200">
                                {jobDetails.time}
                              </h3>
                            </div>
                            <div className="flex items-center gap-1 mt-2 dark:text-gray-200">
