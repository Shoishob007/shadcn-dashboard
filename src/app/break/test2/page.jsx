...
const JobCardPage = () => {
  ...
  return (
    <div>
      <h1>Recent Job Applied</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {jobs.map((job, index) => {
          const progressSteps = ["Applied", "In Review","Coding Test", "Interview", "Offer"];
          // const currentStepIndex = progressSteps.indexOf(job.applicantStatus);
          const currentStepIndex = progressSteps.indexOf(job.applicantStatus) + 1;
          return (
