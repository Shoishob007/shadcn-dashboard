...
import defaultCoverImg from '../../../../../public/assests/profile-banner.jpg';
import defaultAvaterImg from '../../../../../public/assests/applicant.png';
import {
  Dialog,
  DialogClose,
  DialogContent,
...
export default function EditPopup() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="h-full flex flex-col gap-0 overflow-y-visible p-0 sm:max-w-lg [&>button:last-child]:top-3.5">
        ...
        <div className="overflow-y-auto">
          <ProfileBg defaultImage={defaultCoverImg} />
          <Avatar defaultImage={defaultAvaterImg} />
