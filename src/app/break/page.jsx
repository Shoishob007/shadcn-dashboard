...
export const interviewList = [
  {
    ...
    salary: "$70,000",
    details:
      "A great opportunity to join a dynamic team and work on exciting frontend projects.",
    status: "shortlisted",
    role: "Developer",
  },
  {
    ...
    <div className="px-4">
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {shortlisted.map((data) => (
          <Card
            key={data.id}
            className="border border-gray-200 shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105"
          >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg">
          <DialogHeader>
          ...
          <DialogFooter className="flex justify-end">
            <Button
              onClick={closeDialog}
              className="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg shadow"
            >
              Close
            </Button>
          </DialogFooter>
